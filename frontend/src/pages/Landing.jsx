...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    // If user prefers reduced motion, just show them
    ...
    <div>
      ...
      <section id="home">
        <div className="container text-center">
          <div className="reveal from-bottom" style={{ "--delay": "80ms" }}>
            <h1 className="fw-bold mb-2">
              Draw. Plan. Explore.{" "}
              <span className="text-primary">Smarter.</span>
            </h1>
            <p className="lead text-muted mb-4">
              Sketch your route, save it as a GPX, and get realistic time,
              effort, elevation, places to stop, and weather conditions before
              your adventure.
            </p>
          ...
          <div
            className="ratio ratio-16x9 rounded-4 shadow-lg border overflow-hidden mx-auto reveal from-bottom"
            style={{ maxWidth: 980, "--delay": "160ms" }}
          >
            <video
              src="/media/hero.mp4"
              autoPlay
      ...
      <section id="product">
        <div className="container">
          <h2 className="text-center mb-4 reveal from-bottom">What you get</h2>
          <div className="row g-4">
            <div className="col-lg-6">
              <div
                className="h-100 p-4 rounded-4 border shadow-sm reveal from-left"
                style={{ "--delay": "60ms" }}
              >
            ...
            <div className="col-lg-6">
              <div
                className="h-100 p-4 rounded-4 border shadow-sm reveal from-right"
                style={{ "--delay": "140ms" }}
              >
      ...
      <section id="compare">
        <div className="container">
          <h2 className="text-center mb-1 reveal from-bottom">
            Why we’re better
          </h2>

          {/** data once, not inside the row render */}
          {(() => {
            const cols = [
              {
                title: "Our Planner",
              ...
              <div className="row g-4">
                {cols.map((col, i) => (
                  <div className="col-lg-4" key={col.title}>
                    <div
                      className={`h-100 p-4 rounded-4 border shadow-sm reveal ${
                        i === 0
                          ? "from-left"
                          : i === 1
                          ? "from-bottom"
                      ...
                      style={{ "--delay": `${80 + i * 120}ms` }}
                    >
                      <h5 className="mb-3">{col.title}</h5>

                      {col.items.map((entry) => {
                        if (typeof entry === "string") {
                          // Our Planner: always checked
                          return (
                            <label
                              key={entry}
                        ...
                        const [t, v] = entry; // competitors: [text, true|false|"partial"]
                        return (
                          <label
                            key={t}
                            className="d-flex align-items-center gap-2 mb-2"
      ...
      <section id="peek">
        <div className="container">
          <div className="row g-4">
            <div className="col-lg-6">
              <div className="p-3 rounded-4 border shadow-sm reveal from-left">
            ...
            <div className="col-lg-6">
              <div
                className="p-3 rounded-4 border shadow-sm reveal from-right"
                style={{ "--delay": "120ms" }}
              >
          ...
          <div
            className="text-center mt-4 reveal from-bottom"
            style={{ "--delay": "180ms" }}
          >
